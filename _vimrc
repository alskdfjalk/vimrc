...
" 对部分语言设置单独的缩进
au FileType scheme,racket,lisp,clojure,lua,ruby,scala,elixir,julia,dart,coffee,sh,eruby,slim,jade set shiftwidth=8
au FileType scheme,racket,lisp,clojure,lua,ruby,scala,elixir,julia,dart,coffee,sh,eruby,slim,jade set tabstop=8
